#' @title TSCI with Random Forest
#' @description Implement random forest using data splitting and do inference with violation space selection
#'
...
#' @param min.node.size minimal size of each leaf node, default by sequence 5,10,15.
...
#'     \item{\code{SigmaYD}}{estimated covariance between error terms in outcome and treatment models.}
